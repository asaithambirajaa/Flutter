...
class AuthController extends GetxController {
  ...
  Rxn<List<UserModel>> finalUserModel = Rxn<List<UserModel>>();

  List<UserModel> get usersModelList => finalUserModel.value!;
  ...
  void onReady() async {
    ...
    finalUserModel.bindStream(streamDemo());
  ...
  Stream<List<UserModel>> streamDemo() {
    return FirebaseFirestore.instance.collection('users').snapshots().map((ds) {
      var mapData = ds.docs;
      List<UserModel> usersModelList = [];
      mapData.forEach((element) {
        usersModelList.add(UserModel.fromMap(element.data()));
      });
